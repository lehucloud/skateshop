...
import { deleteProduct, deleteProducts, updateProduct } from "@/lib/actions/product"
                ...
                <div className="w-full overflow-x-auto">
                    <div className="mx-auto flex w-fit items-center gap-2 rounded-md border bg-background p-2 text-foreground shadow">
                        ...
                        <div className="flex items-center gap-1.5">
                            <Select
                                onValueChange={(value: ExtraProduct["status"]) => {
                            ...
                            <Select
                                // onValueChange={(value: ExtraProduct["inventory"]) => {
                                    // setAction("update-inventory")
                            ...
                            >
                                ...
                                <SelectContent align="center">
                                    <SelectGroup>
                                        {/* {products.priority.enumValues.map((priority) => (
                                            <SelectItem
                                                key={priority}
                                                value={priority}
                                                className="capitalize"
